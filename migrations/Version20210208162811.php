 ...
 */
final class Version20210208162811 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD author_id INT NOT NULL, ADD category_id INT NOT NULL, ADD type_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post DROP author_id, DROP category_id, DROP type_id');
    }
}
